...
import AdjConjShortPastGame from './adjective-conj-short-past-game';
...
import VerbConjShortPastGame from './verb-conj-short-past-game';
...
class MainView extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            games: {
                ...
                "adj-short-pres-conj": {name: "Short Present Adjective Conjugation", value: false, validWordTypes: ["i-adjective", "na-adjective"]},
                "adj-short-past-conj": {name: "Short Past Adjective Conjugation", value: false, validWordTypes: ["i-adjective", "na-adjective"]},
                ...
                "verb-pres-short-conj": {name: "Short Present Verb Conjugation", value: false, validWordTypes: ["irregular-verb", "ru-verb", "u-verb"]},
                "verb-past-short-conj": {name: "Short Past Verb Conjugation", value: false, validWordTypes: ["irregular-verb", "ru-verb", "u-verb"]},
    ...
    render() {
        ...
        if (display === "menu") {
            ...
            else if (display === "adj-short-pres-conj") game = <AdjConjShortPresentGame key={word.english+word.romaji} word={word} nextHandler={(correct) => this.nextHandler(correct)}/>;
            else if (display === "adj-short-past-conj") game = <AdjConjShortPastGame key={word.english+word.romaji} word={word} nextHandler={(correct) => this.nextHandler(correct)}/>;
            ...
            else if (display === "verb-past-short-conj") game = <VerbConjShortPastGame key={word.english+word.romaji} word={word} nextHandler={(correct) => this.nextHandler(correct)}/>;
